...
namespace Microsoft.AspNet.Identity.Dapper.Test
{
    /// <summary>
    ...
    public class UserManager<TUser, TKey> : Microsoft.AspNet.Identity.UserManager<TUser,TKey>, IDisposable
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        {
            ThrowIfDisposed();
            await Store.DeleteAsync(user).ConfigureAwait(false);
            return IdentityResult.Success;
        }
        ...
        public virtual async Task<bool> CheckPasswordAsync(TUser user, string password)
        {
            ...
            return await VerifyPasswordAsync(passwordStore, user, password).ConfigureAwait(false);
        }
        ...
        public virtual async Task<bool> HasPasswordAsync(TKey userId)
        {
            ...
            return await passwordStore.HasPasswordAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> AddPasswordAsync(TKey userId, string password)
        {
            ...
            var hash = await passwordStore.GetPasswordHashAsync(user).ConfigureAwait(false);
            if (hash != null)
            {
            ...
            string newPassword)
        {
            ...
            if (await VerifyPasswordAsync(passwordStore, user, currentPassword).ConfigureAwait(false))
            {
        ...
        public virtual async Task<IdentityResult> RemovePasswordAsync(TKey userId)
        {
            ...
            await passwordStore.SetPasswordHashAsync(user, null).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
            ...
            TUser user, string newPassword)
        {
            ...
            await
                passwordStore.SetPasswordHashAsync(user, PasswordHasher.HashPassword(newPassword)).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return IdentityResult.Success;
        }
        ...
        public virtual async Task<string> GetSecurityStampAsync(TKey userId)
        {
            ...
            return await securityStore.GetSecurityStampAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> UpdateSecurityStampAsync(TKey userId)
        {
            ...
            await securityStore.SetSecurityStampAsync(user, NewSecurityStamp()).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        {
            ThrowIfDisposed();
            return await GenerateUserTokenAsync("ResetPassword", userId);
        }
        ...
        public virtual async Task<IdentityResult> ResetPasswordAsync(TKey userId, string token, string newPassword)
        {
            ...
            if (!await VerifyUserTokenAsync(userId, "ResetPassword", token).ConfigureAwait(false))
            {
        ...
        internal async Task UpdateSecurityStampInternal(TUser user)
        {
            ...
            {
                await GetSecurityStore().SetSecurityStampAsync(user, NewSecurityStamp()).ConfigureAwait(false);
            }
        }
        ...
        public virtual async Task<IdentityResult> RemoveLoginAsync(TKey userId, UserLoginInfo login)
        {
            ...
            await loginStore.RemoveLoginAsync(user, login).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> AddLoginAsync(TKey userId, UserLoginInfo login)
        {
            ...
            var existingUser = await FindAsync(login).ConfigureAwait(false);
            if (existingUser != null)
            {
                return IdentityResult.Failed(Resources.ExternalLoginExists);
            }
            await loginStore.AddLoginAsync(user, login).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IList<UserLoginInfo>> GetLoginsAsync(TKey userId)
        {
            ...
            return await loginStore.GetLoginsAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> AddClaimAsync(TKey userId, Claim claim)
        {
            ...
            await claimStore.AddClaimAsync(user, claim).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> RemoveClaimAsync(TKey userId, Claim claim)
        {
            ...
            await claimStore.RemoveClaimAsync(user, claim).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IList<Claim>> GetClaimsAsync(TKey userId)
        {
            ...
            return await claimStore.GetClaimsAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> RemoveFromRoleAsync(TKey userId, string role)
        {
            ...
            if (!await userRoleStore.IsInRoleAsync(user, role).ConfigureAwait(false))
            {
        ...
        public virtual async Task<bool> IsInRoleAsync(TKey userId, string role)
        {
            ...
            return await userRoleStore.IsInRoleAsync(user, role).ConfigureAwait(false);
        }
        ...
        public virtual async Task<string> GetEmailAsync(TKey userId)
        {
            ...
            return await store.GetEmailAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> SetEmailAsync(TKey userId, string email)
        {
            ...
            await store.SetEmailAsync(user, email).ConfigureAwait(false);
            await store.SetEmailConfirmedAsync(user, false).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<bool> IsEmailConfirmedAsync(TKey userId)
        {
            ...
            return await store.GetEmailConfirmedAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<string> GetPhoneNumberAsync(TKey userId)
        {
            ...
            return await store.GetPhoneNumberAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> SetPhoneNumberAsync(TKey userId, string phoneNumber)
        {
            ...
            await store.SetPhoneNumberAsync(user, phoneNumber).ConfigureAwait(false);
            await store.SetPhoneNumberConfirmedAsync(user, false).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> ChangePhoneNumberAsync(TKey userId, string phoneNumber, string token)
        {
            ...
            if (await VerifyChangePhoneNumberTokenAsync(userId, token, phoneNumber).ConfigureAwait(false))
            {
                await store.SetPhoneNumberAsync(user, phoneNumber).ConfigureAwait(false);
                await store.SetPhoneNumberConfirmedAsync(user, true).ConfigureAwait(false);
                await UpdateSecurityStampInternal(user).ConfigureAwait(false);
                return await UpdateAsync(user).ConfigureAwait(false);
            }
            return IdentityResult.Failed(Resources.InvalidToken);
        ...
        public virtual async Task<bool> IsPhoneNumberConfirmedAsync(TKey userId)
        {
            ...
            return await store.GetPhoneNumberConfirmedAsync(user).ConfigureAwait(false);
        }
        ...
        {
            return
                new SecurityToken(Encoding.Unicode.GetBytes(await GetSecurityStampAsync(userId).ConfigureAwait(false)));
        }
        ...
        public virtual async Task<string> GenerateChangePhoneNumberTokenAsync(TKey userId, string phoneNumber)
        {
            ThrowIfDisposed();
            return
                Rfc6238AuthenticationService.GenerateCode(await CreateSecurityTokenAsync(userId), phoneNumber)
        ...
        {
            ThrowIfDisposed();
            var securityToken = await CreateSecurityTokenAsync(userId);
            int code;
        ...
        public virtual async Task<bool> VerifyUserTokenAsync(TKey userId, string purpose, string token)
        {
            ...
            return await UserTokenProvider.ValidateAsync(purpose, token, this, user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<string> GenerateUserTokenAsync(string purpose, TKey userId)
        {
            ...
            return await UserTokenProvider.GenerateAsync(purpose, this, user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<bool> VerifyTwoFactorTokenAsync(TKey userId, string twoFactorProvider, string token)
        {
            ...
            return await provider.ValidateAsync(twoFactorProvider, token, this, user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<string> GenerateTwoFactorTokenAsync(TKey userId, string twoFactorProvider)
        {
            ...
            return await _factors[twoFactorProvider].GenerateAsync(twoFactorProvider, this, user).ConfigureAwait(false);
        }

        /// <summary>
        ///     Notify a user with a token from a specific two factor provider
        /// </summary>
        /// <param name="userId"></param>
        /// <param name="twoFactorProvider"></param>
        /// <param name="token"></param>
            ...
            string token)
        {
            ...
            await _factors[twoFactorProvider].NotifyAsync(token, this, user).ConfigureAwait(false);
            return IdentityResult.Success;
        }
        ...
        public virtual async Task<bool> GetTwoFactorEnabledAsync(TKey userId)
        {
            ...
            return await store.GetTwoFactorEnabledAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> SetTwoFactorEnabledAsync(TKey userId, bool enabled)
        {
            ...
            await store.SetTwoFactorEnabledAsync(user, enabled).ConfigureAwait(false);
            await UpdateSecurityStampInternal(user).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task SendSmsAsync(TKey userId, string message)
        {
            ...
            if (SmsService != null)
            {
                var msg = new IdentityMessage
                {
                    Destination = await GetPhoneNumberAsync(userId),
                    Body = message
                };
                await SmsService.SendAsync(msg);
            }
        }
        ...
        public virtual async Task<bool> IsLockedOutAsync(TKey userId)
        {
            ...
            if (await store.GetLockoutEnabledAsync(user).ConfigureAwait(false))
            {
                var lockoutTime = await store.GetLockoutEndDateAsync(user).ConfigureAwait((false));
        ...
        public virtual async Task<IdentityResult> SetLockoutEnabledAsync(TKey userId, bool enabled)
        {
            ...
            await store.SetLockoutEnabledAsync(user, enabled).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<bool> GetLockoutEnabledAsync(TKey userId)
        {
            ...
            return await store.GetLockoutEnabledAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<DateTimeOffset> GetLockoutEndDateAsync(TKey userId)
        {
            ...
            return await store.GetLockoutEndDateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<IdentityResult> SetLockoutEndDateAsync(TKey userId, DateTimeOffset lockoutEnd)
        {
            ...
            await store.SetLockoutEndDateAsync(user, lockoutEnd).ConfigureAwait(false);
            return await UpdateAsync(user).ConfigureAwait(false);
        }

        /// <summary>
        ///     Increments the access failed count for the user and if the failed access count is greater than or equal
        ///     to the MaxFailedAccessAttemptsBeforeLockout, the user will be locked out for the next DefaultAccountLockoutTimeSpan
        ...
        public virtual async Task<IdentityResult> AccessFailedAsync(TKey userId)
        {
            ...
            var count = await store.IncrementAccessFailedCountAsync(user).ConfigureAwait(false);
            if (count >= MaxFailedAccessAttemptsBeforeLockout)
            {
                ...
                await store.ResetAccessFailedCountAsync(user).ConfigureAwait(false);
            }
            return await UpdateAsync(user).ConfigureAwait(false);
        }
        ...
        public virtual async Task<int> GetAccessFailedCountAsync(TKey userId)
        {
            ...
            return await store.GetAccessFailedCountAsync(user).ConfigureAwait(false);
        }
    ...
    internal static class Resources
    {
        ...
        public static string UserIdNotFound { get; set; }

        public static IEnumerable<string> UserNotInRole { get; set; }

        public static IEnumerable<string> UserAlreadyInRole { get; set; }

        public static string StoreNotIUserRoleStore { get; set; }

        public static string StoreNotIUserClaimStore { get; set; }

        public static string[] ExternalLoginExists { get; set; }

        public static string StoreNotIUserLoginStore { get; set; }

        public static string[] InvalidToken { get; set; }

        public static string StoreNotIUserSecurityStampStore { get; set; }

        public static string[] PasswordMismatch { get; set; }

        public static IEnumerable<string> UserAlreadyHasPassword { get; set; }

        public static string StoreNotIUserPasswordStore { get; set; }

        public static string StoreNotIQueryableUserStore { get; set; }

        public static string NoTokenProvider { get; set; }

        public static string NoTwoFactorProvider { get; set; }

        public static string StoreNotIUserTwoFactorStore { get; set; }

        public static string StoreNotIUserLockoutStore { get; set; }

        public static string[] LockoutNotEnabled { get; set; }

        public static string StoreNotIUserEmailStore { get; set; }

        public static string StoreNotIUserPhoneNumberStore { get; set; }
    }
}